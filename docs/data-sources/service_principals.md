...
- `app_roles` (Attributes List) The roles exposed by the application which this service principal represents. For more information see the appRoles property definition on the application entity. Not nullable. (see [below for nested schema](#nestedatt--value--app_roles))
...
- `verified_publisher` (Attributes) Specifies the verified publisher of the application which this service principal represents. (see [below for nested schema](#nestedatt--value--verified_publisher))
