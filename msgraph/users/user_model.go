...
type userModel struct {
	...
	AssignedLicenses                []userAssignedLicensesModel             `tfsdk:"assigned_licenses"`
	AssignedPlans                   []userAssignedPlansModel                `tfsdk:"assigned_plans"`
	AuthorizationInfo               *userAuthorizationInfoModel             `tfsdk:"authorization_info"`
	...
	EmployeeOrgData                 *userEmployeeOrgDataModel               `tfsdk:"employee_org_data"`
	...
	Identities                      []userIdentitiesModel                   `tfsdk:"identities"`
	...
	LicenseAssignmentStates         []userLicenseAssignmentStatesModel      `tfsdk:"license_assignment_states"`
	...
	OnPremisesExtensionAttributes   *userOnPremisesExtensionAttributesModel `tfsdk:"on_premises_extension_attributes"`
	...
	OnPremisesProvisioningErrors    []userOnPremisesProvisioningErrorsModel `tfsdk:"on_premises_provisioning_errors"`
	...
	ProvisionedPlans                []userProvisionedPlansModel             `tfsdk:"provisioned_plans"`
	...
	ServiceProvisioningErrors       []userServiceProvisioningErrorsModel    `tfsdk:"service_provisioning_errors"`
	ShowInAddressList               types.Bool                              `tfsdk:"show_in_address_list"`
	SignInActivity                  *userSignInActivityModel                `tfsdk:"sign_in_activity"`
