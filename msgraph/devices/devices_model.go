...
type devicesModel struct {
	Value []devicesValueModel `tfsdk:"value"`
}

type devicesValueModel struct {
	Id                            types.String                         `tfsdk:"id"`
	DeletedDateTime               types.String                         `tfsdk:"deleted_date_time"`
	AccountEnabled                types.Bool                           `tfsdk:"account_enabled"`
	AlternativeSecurityIds        []devicesAlternativeSecurityIdsModel `tfsdk:"alternative_security_ids"`
...
type devicesAlternativeSecurityIdsModel struct {
