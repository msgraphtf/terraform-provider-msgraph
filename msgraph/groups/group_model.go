...
type groupModel struct {
	...
	AssignedLabels                []groupAssignedLabelsModel               `tfsdk:"assigned_labels"`
	AssignedLicenses              []groupAssignedLicensesModel             `tfsdk:"assigned_licenses"`
	...
	LicenseProcessingState        *groupLicenseProcessingStateModel        `tfsdk:"license_processing_state"`
	...
	OnPremisesProvisioningErrors  []groupOnPremisesProvisioningErrorsModel `tfsdk:"on_premises_provisioning_errors"`
	...
	ServiceProvisioningErrors     []groupServiceProvisioningErrorsModel    `tfsdk:"service_provisioning_errors"`
